...
```{r echo=FALSE, warning=FALSE, fig.cap = "", results = 'asis'}
wide_event_table(quadrant1id, max_larger = max_deaths_all_events) 

outcome_reactable(quadrant1_outcomes)

if ("None" %in% quadrant1$outcome){
 cat("The Total in the outcomes table includes events whose outcome was coded as None.\n\n") 
}
cat(paste(datafiles_footer(es=TRUE),"\n\n",sep=""))
cat(paste(cluster.2019.explanation,"\n\n",sep=""))
```
...
```{r hypothesis-analysis2, results = 'asis'}
#| label: hypothesis-analysis2
#| tbl-cap: "Qualitative Comparative Analysis"
#| warning: false
...
```{r hypothesis-analysis2-table, echo=FALSE, results = 'asis'}
#| label: hypothesis-analysis2-table
